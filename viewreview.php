...
</br></br><br><br><br> <table align='center' border=0 style="background:transparent; color:black;box-shadow:7px 7px 7px 2px #afabaa;" cellspacing=0 rules='none'cellpadding=2 width=65% height=80%>
<tr>
 <td colspan=8 align='center'> <font size="6" style="color:#90c317;">All REVIEWS </td></br>
...
{ echo "<tr>";
 echo "<td><font size='5' style='font-weight:bold'><span align='center' style='color:red;' class='mr-2 icon-user'></span>$row[1]</td></tr>"; 
echo "<tr><td><font size='5'>$row[2]</td>";

echo "<td><font size='5'>$row[3] <span align='center' style='color:gold' class='mr-2 icon-star'></span></td>";
