...
<br><br>
    ...
    <?php
				  ...
				  <section class="home-section section-hero overlay bg-video"  id="home-section">
       <video autoplay muted loop playsinline style='width:100%; object-fit:over;'>
	   <source src='images/video.mp4' type='video/mp4' >
	   </video>
	   <div class="container">
      ...
      <div class="container"  >
        ...
        <ul class="job-listings mb-5" style="border-color:#fff;background-color:white;">
          <?php
			...
			$r=mysqli_query($con,"select * from company where id>20 && id<31 &&  deadline>=current_date");
			while($row=mysqli_fetch_array($r)){
        ...
        <div class="row pagination-wrap">
          ...
          <div class="col-md-6 text-center text-md-right">
            <div class="custom-pagination ml-auto">
              ...
              <a href="index3.php" class="active">3</a>
    ...
    <footer class="site-footer">
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-6 col-md-3 mb-4 mb-md-0">
            ...
            <div class="footer-social">
              <a href="#" style="background-color:#121212;"><span class="icon-facebook"></span></a>
              <a href="#" style="background-color:#121212;"><span class="icon-twitter"></span></a>
              <a href="#" style="background-color:#121212;"><span class="icon-instagram"></span></a>
              <a href="#" style="background-color:#121212;"><span class="icon-linkedin"></span></a>
            </div>
          </div>
        </div>
        ...
        <div class="row text-center">
          <div class="col-12">
            <p class="copyright" style="color:#90c317;"><small>
