...
<li class='li active'><a href="viewreplies.php">REPLIES</a></LI><li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
...
<tr>
 <td colspan=8 align='center'> <font size="7" color='black'>Replies by the admin to user</td></br>
</tr> <tr>
<th align='left' style="color:#132020">Id</th>
<th align='left' style="color:#132020">Username</th>
<th align='left' style="color:#132020">replies</th>
<th align='left' style="color:#132020">Query</th>


<?php
$con=mysqli_connect("localhost","root","","jobnet");
$r=mysqli_query($con,"select * from replies ");
...
echo "<td>$row[1]</td>"; 
echo "<td>$row[2]</td>";
echo "<td><a href='viewquery.php?a=$row[1]' style='color:black;'>Query</a></td></tr>";
...
?>
  ...
  <table  height='100%' width='100%' border='0' align='center' style="background:#afabaa; color:white;box-shadow:7px 7px 7px 2px black;margin-top:-10px;" cellspacing=1  cellpadding=8>
<tr>
 <td colspan=8 align='center'> <font size="7" color='black'>Replies by the admin to company</td></br>
</tr> <tr>
<th align='left' style="color:#132020">Id</th>
<th align='left' style="color:#132020">Username</th>
<th align='left' style="color:#132020">replies</th>
...
<?php
$con=mysqli_connect("localhost","root","","jobnet");
$r=mysqli_query($con,"select * from companyreply ");
