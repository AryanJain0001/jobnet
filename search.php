        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
			...
			$s=mysqli_select_db($con,"jobnet");
			 ...
			 echo "<select name='nm' class='selectpicker' data-style='btn-white btn-lg' data-width='100%' data-live-search='true' title='job title' >";
			...
			$s=mysqli_select_db($con,"jobnet");
			 ...
			 echo "<select name='drop' class='selectpicker' data-style='btn-white btn-lg' data-width='100%' data-live-search='true' title='location' >";
...
<br><br>
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
			...
			<br><br>
			  ...
			  <h1 class="text-black font-weight-bold">Be our member</h1>
			 <a href="signup1.php" style="border-color:#90c317;margin-left:-50px;" class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-add user"></span>Sign Up</a>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-2">Related Jobs listed below</h2>
          </div>
        </div>
	  ...
	  $drop=$_POST['drop'];
			...
			$r=mysqli_query($con,"select * from company where field='$nm' and type='$time' and location like '%$drop%'");
		  ...
		  <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            ...
            <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
              ...
              <div class="job-listing-meta">
                <span class="badge badge-success"><?php echo $row[6]; ?></span>
              </div>
            </div>
            
          </li>
<?php }
else echo "<h3 align='center'>no jobs found</h3>"; ?>
        ...
        <div class="row mb-5">
          ...
          <div class="col-6 col-md-3 mb-4 mb-md-0">
            ...
            <div class="footer-social">
              <a href="#" style="background-color:#90c317;"><span class="icon-facebook"></span></a>
              <a href="#" style="background-color:#90c317;"><span class="icon-twitter"></span></a>
              <a href="#" style="background-color:#90c317;"><span class="icon-instagram"></span></a>
              <a href="#" style="background-color:#90c317;"><span class="icon-linkedin"></span></a>
            </div>
          </div>
        </div>
