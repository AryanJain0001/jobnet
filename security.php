...
<tr>   </tr><tr> <td colspan=2 align='center' ><h3 style="margin-left:200px;" class="h3 d-flex  align-items-center mb-10 text-primary">FORGOT PASSWORD</h3></td></tr>
...
<tr>
  <td align='center' width=50%>USERNAME</td>
	<td colspan='3' align='center' width=50%><input type='text'   required name='nm' value=''></td>
  </tr>
  <tr><td></td></tr>
  <tr><td></td></tr>
  <tr><td></td></tr>
    <td align='center' width=50%>SECURITY PIN</td>
	<td colspan='3' align='center' width=50%><input type='password'   required name='sp' value=''></td>
