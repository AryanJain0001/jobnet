...
<?php
 ...
 $cnm=$_SESSION['cnm'];
   $con=mysqli_connect("localhost","root","","jobnet");
    $r=mysqli_query($con,"select * from companyquery where companyname='$cnm'");
...
{ 
      ...
      $nm= $_POST['nm'];
        ...
        $q=mysqli_query($con,"insert into companyreply(companyname,reply)
              values('$nm','$reply')");
...
<table border='0' cellspacing=0 cellpadding=12 align='center' style="background:#afabaa; color:white;" width=100% height=100%>
	<tr>
	<td colspan='2'align='center'><font size="6" color='black'>Reply to company query </td>
	</tr>
	<tr><td width='600px' align='center'><font size="4" >COMPANY NAME:<td width='600px' >
	<input type='text' name='nm' value =''   align='center'style='width:260px;height:30px'></td>
	</tr>
