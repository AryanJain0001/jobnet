...
<li class='li active'><a href="viewquery.php">QUERIES</a></LI><li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
...
<table  height='100%' width='100%' border='0' align='center' style="background:#afabaa; color:white;margin-top:-30px;box-shadow:7px 7px 7px 2px black;" cellspacing=1  cellpadding=8>
<tr>
 <td colspan=8 align='center'> <font size="7" color='black'>Queries from users </td></br>
</tr> <tr>
<th align='left' style="color:#132020">Id</th>
<th align='left' style="color:#132020">Username</th>
<th align='left' style="color:#132020">Queries</th>
<th align='left' style="color:#132020">Action</th>

<?php
$con=mysqli_connect("localhost","root","","jobnet");
$r=mysqli_query($con,"select * from help ");
...
echo "<td>$row[1]</td>"; 
echo "<td>$row[2]</td>";
echo "<td><a href='reply.php?a=$row[1]' style='color:black'>Reply</a></td></tr>";
...
<table  height='100%' width='100%' border='0' align='center' style="background:#afabaa; color:white;margin-top:-30px;box-shadow:7px 7px 7px 2px black;" cellspacing=1  cellpadding=8>
<tr>
 <td colspan=8 align='center'> <font size="7" color='black'>Queries from Companies </td></br>
</tr> <tr>
<th align='left' style="color:#132020">Id</th>
...
<?php
$con=mysqli_connect("localhost","root","","jobnet");
$r=mysqli_query($con,"select * from companyquery ");
...
echo "<td>$row[1]</td>"; 
echo "<td>$row[2]</td>";
echo "<td><a href='comreply.php?a=$row[1]' style='color:black'>Reply</a></td></tr>";
