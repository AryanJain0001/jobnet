...
<tr>
 <td colspan=8 align='center'> <font size="7" style="color:#90c317; ">APPLIED </td></br>
...
$r=mysqli_query($con,"select * from cv where name='$id'");
...
echo "<td><font size='5' style='font-weight:bold'>$row[2] &nbsp;&nbsp;&nbsp;-></td>"; 
echo "<td><font size='4'>$row[1] &nbsp;&nbsp;&nbsp;&nbsp;-></td>";
echo "<td><font size='4'>$row[3]</td>";
echo "<td><a href='remove.php?d=$row[2]' style='font-size:4;color:red;'>remove</td>";

}}
else
	{ echo "<script>alert('You have not applied anywhere yet.') 
