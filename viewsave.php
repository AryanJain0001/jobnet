...
<li class='li active'><a href="viewsave.php" style="display:block;">SAVED JOBS</a></li><li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
</ul>
</div>
...
<tr>
 <td colspan=8 align='center'> <font size="7" color='black'>ALL THE SAVED JOBS BY THE USER</td></br>
</tr> <tr>
...
$r=mysqli_query($con,"select * from save ");
